...
<head>
  ...
  <!-- icona + titolo -->
  <link rel="icon" href="">
  <title>Sito streaming - Top 5</title>
...
<body>
  ...
  <div class="container-fluid pt-3">
    ...
    <div class="row justify-content-center">
      <div class="col-10">
        <!-- TOP 5 VIDEO PER VISUALIZZAZIONI-->
        <h2 class="titleText mt-3">Top 5 video per visualizzazioni</h2>
        <div class="row">
        <?php
          // Dati dei video con più visualizzioni
          $sql="SELECT * FROM Video v JOIN Accounts a ON v.IdAccount=a.IdAccount ORDER BY NumeroVisualizzazioni DESC LIMIT 5";
        ...
        <!-- TOP 5 VIDEO PER LIKES-->
        <h2 class="titleText mt-3">Top 5 video per numero like</h2>
        <div class="row">
        <?php
